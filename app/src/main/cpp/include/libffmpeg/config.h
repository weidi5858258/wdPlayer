...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-openssl --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vdpau --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --disable-iconv --enable-protocol=async --disable-linux-perf --disable-bzlib --prefix=/root/mydev/workspace_android/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/root/mydev/workspace_android/ijkplayer-android/android/contrib/build/openssl-armv7a/output/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/root/mydev/workspace_android/ijkplayer-android/android/contrib/build/openssl-armv7a/output/lib -lssl -lcrypto -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/root/mydev/workspace_android/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/root/mydev/workspace_android/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
...
#define CONFIG_IJKLIVEHOOK_DEMUXER 1
#define CONFIG_IJKSWITCH_DEMUXER 1
#define CONFIG_IJKDASH_DEMUXER 1
#define CONFIG_IJKLIVEDASH_DEMUXER 1
#define CONFIG_IJKIOPROXY_DEMUXER 1
#define CONFIG_IJKOFFLINEHOOK_DEMUXER 1
...
#define CONFIG_IJKFILEHOOK_PROTOCOL 1
