 ...
 */
package com.weidi.media.wdplayer.exo;
 ...
 */
public final class ExoMediaFormat implements Parcelable {
  ...
  public static ExoMediaFormat createVideoFormat(String trackId, String mimeType, int bitrate,
  ...
  public static ExoMediaFormat createVideoFormat(String trackId, String mimeType, int bitrate,
    ...
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
  ...
  public static ExoMediaFormat createAudioFormat(String trackId, String mimeType, int bitrate,
  ...
  public static ExoMediaFormat createAudioFormat(String trackId, String mimeType, int bitrate,
    ...
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, NO_VALUE, NO_VALUE,
  ...
  public static ExoMediaFormat createTextFormat(String trackId, String mimeType, int bitrate,
  ...
  public static ExoMediaFormat createTextFormat(String trackId, String mimeType, int bitrate,
    ...
    return new ExoMediaFormat(trackId, mimeType, bitrate, NO_VALUE, durationUs, NO_VALUE, NO_VALUE,
  ...
  public static ExoMediaFormat createTextFormat(String trackId, String mimeType, int bitrate,
                                                long durationUs, String language, long subsampleOffsetUs, int framerate) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, NO_VALUE, durationUs, NO_VALUE, NO_VALUE,
        NO_VALUE, NO_VALUE, NO_VALUE, NO_VALUE, language, subsampleOffsetUs, null, false, NO_VALUE,
        NO_VALUE, NO_VALUE, NO_VALUE, NO_VALUE, null, NO_VALUE, framerate);
  }

  public static ExoMediaFormat createImageFormat(String trackId, String mimeType, int bitrate,
  ...
  public static ExoMediaFormat createFormatForMimeType(String trackId, String mimeType, int bitrate,
                                                       long durationUs) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, NO_VALUE, durationUs, NO_VALUE, NO_VALUE,
  ...
  public static ExoMediaFormat createId3Format() {
    return createFormatForMimeType(null, MimeTypes.APPLICATION_ID3, ExoMediaFormat.NO_VALUE,
        C.UNKNOWN_TIME_US);
  }

  /* package */ ExoMediaFormat(Parcel in) {
  ...
  /* package */ ExoMediaFormat(String trackId, String mimeType, int bitrate, int maxInputSize,
  ...
  ExoMediaFormat(String trackId, String mimeType, int bitrate, int maxInputSize,
                 long durationUs, int width, int height, int rotationDegrees, float pixelWidthHeightRatio,
                 int channelCount, int sampleRate, String language, long subsampleOffsetUs,
                 List<byte[]> initializationData, boolean adaptive, int maxWidth, int maxHeight,
                 int pcmEncoding, int encoderDelay, int encoderPadding, byte[] projectionData,
                 int stereoMode) {
    this(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height, rotationDegrees,
        pixelWidthHeightRatio, channelCount, sampleRate, language, subsampleOffsetUs,
        initializationData, adaptive, maxWidth, maxHeight, pcmEncoding, encoderDelay,
        encoderPadding, projectionData, stereoMode, NO_VALUE);
  }

  public ExoMediaFormat copyWithMaxInputSize(int maxInputSize) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
  ...
  public ExoMediaFormat copyWithMaxVideoDimensions(int maxWidth, int maxHeight) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
        rotationDegrees, pixelWidthHeightRatio, channelCount, sampleRate, language,
        subsampleOffsetUs, initializationData, adaptive, maxWidth, maxHeight, pcmEncoding,
        encoderDelay, encoderPadding, projectionData, stereoMode);
  ...
  public ExoMediaFormat copyWithSubsampleOffsetUs(long subsampleOffsetUs) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
        rotationDegrees, pixelWidthHeightRatio, channelCount, sampleRate, language,
        subsampleOffsetUs, initializationData, adaptive, maxWidth, maxHeight, pcmEncoding,
        encoderDelay, encoderPadding, projectionData, stereoMode);
  ...
  public ExoMediaFormat copyWithDurationUs(long durationUs) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
        rotationDegrees, pixelWidthHeightRatio, channelCount, sampleRate, language,
        subsampleOffsetUs, initializationData, adaptive, maxWidth, maxHeight, pcmEncoding,
        encoderDelay, encoderPadding, projectionData, stereoMode);
  ...
  public ExoMediaFormat copyWithLanguage(String language) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
        rotationDegrees, pixelWidthHeightRatio, channelCount, sampleRate, language,
        subsampleOffsetUs, initializationData, adaptive, maxWidth, maxHeight, pcmEncoding,
        encoderDelay, encoderPadding, projectionData, stereoMode);
  ...
  public ExoMediaFormat copyWithFixedTrackInfo(String trackId, int bitrate, int width, int height,
                                               String language) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
        rotationDegrees, pixelWidthHeightRatio, channelCount, sampleRate, language,
  ...
  public ExoMediaFormat copyAsAdaptive(String trackId) {
    return new ExoMediaFormat(trackId, mimeType, NO_VALUE, NO_VALUE, durationUs, NO_VALUE, NO_VALUE,
  ...
  public ExoMediaFormat copyWithGaplessInfo(int encoderDelay, int encoderPadding) {
    return new ExoMediaFormat(trackId, mimeType, bitrate, maxInputSize, durationUs, width, height,
        rotationDegrees, pixelWidthHeightRatio, channelCount, sampleRate, language,
        subsampleOffsetUs, initializationData, adaptive, maxWidth, maxHeight, pcmEncoding,
        encoderDelay, encoderPadding, projectionData, stereoMode);
  ...
  /**
   * @return A {@link ExoMediaFormat} representation of this format.
   */
  ...
  public final android.media.MediaFormat getFrameworkMediaFormatV16() {
    if (frameworkMediaFormat == null) {
      ...
      maybeSetIntegerV16(format, android.media.MediaFormat.KEY_FRAME_RATE, framerate);
  ...
  public boolean equals(Object obj) {
    ...
    ExoMediaFormat other = (ExoMediaFormat) obj;
    if (adaptive != other.adaptive || bitrate != other.bitrate || maxInputSize != other.maxInputSize
        ...
        || rotationDegrees != other.rotationDegrees || framerate != other.framerate
  ...
  public static final Creator<ExoMediaFormat> CREATOR = new Creator<ExoMediaFormat>() {

    @Override
    public ExoMediaFormat createFromParcel(Parcel in) {
      return new ExoMediaFormat(in);
    }

    @Override
    public ExoMediaFormat[] newArray(int size) {
      return new ExoMediaFormat[size];
    }
