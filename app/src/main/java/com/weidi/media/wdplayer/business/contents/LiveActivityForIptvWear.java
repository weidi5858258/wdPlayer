...
public class LiveActivityForIptvWear extends WearableActivity {
    ...
    private void internalCreate(Bundle savedInstanceState) {
        mUiHandler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                LiveActivityForIptvWear.this.uiHandleMessage(msg);
            }
        };
        ...
        if (!PlayerWrapper.mIptvContentsMap.isEmpty()) {
            ...
            if (PlayerWrapper.mIptvContentsMap.size() > 60) {
                // 太多的先加载20个
                mContentsMap.clear();
                for (Map.Entry<String, String> tempMap : PlayerWrapper.mIptvContentsMap.entrySet()) {
                    mContentsCount++;
