...
public class LiveActivityForMenFavoriteWear extends Activity {

    private static final String TAG = "LiveActivityFMFWear";
    ...
    private void internalCreate(Bundle savedInstanceState) {
        mUiHandler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                LiveActivityForMenFavoriteWear.this.uiHandleMessage(msg);
            }
        };
