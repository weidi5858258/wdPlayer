...
public final class C {
  ...
  // AC4 is not supported in AOSP and MTK added ENCODING_AC4
  // in AOSP as 15.
  ...
  /**
   * Indicates normal playback speed for SpeedShiftPlay
   */
  public static final float NORMAL_PLAY_SPEED = 1.0f;

  public static final int MT5891 = 5891;
  public static final int MT5893 = 5893;
  public static final int MT5895 = 5895;
  public static int getChipsetNumber() {
    return Integer.parseInt(Build.HARDWARE.replaceAll("[^0-9]",""));
  }
