...
/*
 ...
 https://www.cnblogs.com/welhzh/p/6079631.html
 */
        ...
        while (!sawOutputEOS && !stopDecode) {
            ...
            if (outputBufferId >= 0) {
                ...
                if (doRender) {
                    ...
                    // 解码后的帧格式是"MediaCodecInfo.CodecCapabilities.COLOR_FormatYUV420Flexible"
                    // 所以image中数据的格式也是"MediaCodecInfo.CodecCapabilities.COLOR_FormatYUV420Flexible"
                    // 如果要得到I420格式的数据,那么需要把image中的数据从
                    // "COLOR_FormatYUV420Flexible"转化为"I420"
