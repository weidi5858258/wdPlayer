...
public final class MimeTypes {
  ...
  public static final String VIDEO_MPEG2TS = BASE_TYPE_VIDEO + "/mp2ts";
  public static final String VIDEO_MPEG2TTS = BASE_TYPE_VIDEO + "/vnd.mtk-mp2tts";
  ...
  public static final String AUDIO_AC4_JOC = BASE_TYPE_AUDIO + "/ac4-joc";
  ...
  public static final String TEXT_SUBRIP = BASE_TYPE_TEXT + "/srt";
  public static final String TEXT_SUBSTATION_ALPHA = BASE_TYPE_TEXT + "/ssa";
  public static final String TEXT_ADVANCED_SUBSTATION_ALPHA = BASE_TYPE_TEXT + "/ass";
  public static final String TEXT_ARIB = BASE_TYPE_TEXT + "/vnd.mtk-caption-jp";
  ...
  public static final String APPLICATION_ADVANCED_SUBSTATION_ALPHA = BASE_TYPE_APPLICATION + "/x-ass";
  public static final String APPLICATION_SAMI = BASE_TYPE_APPLICATION + "/x-sami";
  public static final String APPLICATION_SUBSTATION_ALPHA = BASE_TYPE_APPLICATION + "/x-ssa";
  public static final String APPLICATION_SUBVIEWER_V2 = BASE_TYPE_APPLICATION + "/x-subviewer";
  public static final String APPLICATION_MICRODVD = BASE_TYPE_APPLICATION + "/x-microdvd";
  public static final String APPLICATION_DVD_SUBTITLE_SYSTEM = BASE_TYPE_APPLICATION + "/x-dvdsubsys";
  public static final String APPLICATION_DTCPIP = BASE_TYPE_APPLICATION + "/x-dtcp";

  public static final String APPLICATION_VENDOR_SVP_EIA608 = BASE_TYPE_APPLICATION + "/vnd.svp-eia-608";
  public static final String APPLICATION_VENDOR_SVP_CEA708 = BASE_TYPE_APPLICATION + "/vnd.svp-cea-708";
  public static final String APPLICATION_VENDOR_SVP_ARIB = BASE_TYPE_APPLICATION + "/vnd.svp-arib-subtitle";
